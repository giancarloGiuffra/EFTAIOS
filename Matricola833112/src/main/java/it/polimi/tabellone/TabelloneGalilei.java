...
public class TabelloneGalilei extends Tabellone {
    TabelloneGalilei(){
        ...
        String scialuppeNomi = "B02,V02,B13,V13";
        ...
        String inacessibiliNomi = "A01,A07,A08,B07,D01,D04,D06,D07,E01,E07,E14,F12,F13,F14,H05,H10,H11,I06,I12,J07,J12,K07,K13,L07,M07,N07,O01,O03,O04,R10,R11,R14,S01,S03,S10,S11,S14,T01,T03,T04,T09,T10,V07,W01,W07,W08";
        String baseUmanaNome = "L06";
        String baseALienaNome = "L08";
        String separatore = ",";
        // settori pericolosi quelli non presenti
        ...
        List<Settore> inacessibili = Settore.getListSettoriDiTipo(Arrays.asList(inacessibiliNomi.split(separatore)), TipoSettore.INACCESSIBILE);
